    ...
    <footer class="bg-emerald-400/10 mt-10 text-gray-400 py-10 px-8">
      <div class="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
        ...
        <div>
          ...
          <ul class="space-y-1">
            <li><span class="material-icons text-teal-400 text-sm align-middle">call</span> +91-9876543210</li>
            <li><span class="material-icons text-teal-400 text-sm align-middle">email</span> support@nearbyhappenings.com</li>
          </ul>
        </div>
        <div>
